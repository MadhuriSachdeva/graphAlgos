...
val gra:mutable.Map[Int, List[Int]] = mutable.Map( 0 ->List(1,2,3),
  1 ->List(0,2) , 2 ->List(0,1) , 3 -> List(0,4) , 4 ->List(3))
val gra1:mutable.Map[Int, List[Int]] = mutable.Map( 0 ->List(1), 1
  ->List(0,2) , 2 ->List(1,3) , 3 -> List(2,4) , 4 ->List(3))
...
val d = isCyclic(0,gra,visited)
val e = isCyclic(0,gra1,visited)